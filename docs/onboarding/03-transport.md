...
[`src/zsnoop_mcp/transport.py`]({{ config.repo_url }}/src/branch/{{ repo_branch }}/src/zsnoop_mcp/transport.py) — the
...
[transport.py]({{ config.repo_url }}/src/branch/{{ repo_branch }}/src/zsnoop_mcp/transport.py):
...
[`_capture_remaining_stderr`]({{ config.repo_url }}/src/branch/{{ repo_branch }}/src/zsnoop_mcp/transport.py):
...
landed. Test:
[`test_transport_local_stderr.py`]({{ config.repo_url }}/src/branch/{{ repo_branch }}/tests/test_transport_local_stderr.py).
