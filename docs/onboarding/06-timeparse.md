...
[`src/zsnoop_mcp/timeparse.py`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/src/zsnoop_mcp/timeparse.py) — turns
...
Every test in
[tests/test_timeparse.py](https://github.com/hamsolodev/zsnoop-mcp/blob/main/tests/test_timeparse.py) passes a fixed
...
[`test_last_week_is_previous_monday_midnight`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/tests/test_timeparse.py).
