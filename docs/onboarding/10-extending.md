...
[`tests/test_dispatch.py`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/tests/test_dispatch.py) has an explicit
...
In [`tests/test_methods.py`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/tests/test_methods.py):
...
In [`src/zsnoop_mcp/server.py`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/src/zsnoop_mcp/server.py), inside
`create_server`:
...
In [`tests/test_server.py`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/tests/test_server.py):
