...
[`src/zsnoop_mcp/config.py`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/src/zsnoop_mcp/config.py) — the
...
Test:
[`test_load_config_round_trip`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/tests/test_config.py).
