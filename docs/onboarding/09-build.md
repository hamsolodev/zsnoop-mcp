...
[`pyproject.toml`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/pyproject.toml).
...
This is the line in [pyproject.toml](https://github.com/hamsolodev/zsnoop-mcp/blob/main/pyproject.toml) that ships the
...
[`server.py`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/src/zsnoop_mcp/server.py) handles both cases —
...
All three are wired into [`.pre-commit-config.yaml`](https://github.com/hamsolodev/zsnoop-mcp/blob/main/.pre-commit-config.yaml).
